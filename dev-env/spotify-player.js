					...
					(f.prototype._onGetToken = function (e, t) {
						...
						if ("function" != typeof n) {
							...
							if (this._getListeners(o.PLAYER_INIT_ERROR).length)
								return void this._onEvent({ name: o.PLAYER_INIT_ERROR, eventData: { message: r } });
							throw new Error(r);
						}
						new s(n).then(
							function (e) {
		...
		(function (t) {
			...
			(r = Object.defineProperty
				? function (e, t, n) {
						return e[t]
							? e
							: (Object.defineProperty(e, t, { value: n, configurable: !0, writable: !0 }), e);
				  }
				: function (e, t, n) {
